package me.wakka.valeriaonline.features.minigames.models.scoreboards;
...
public interface MinigameScoreboard {
	...
	class Factory {
		@SneakyThrows
		public static me.pugabyte.bncore.features.minigames.models.scoreboards.MinigameScoreboard create(Match match) {
	...
	class Teams implements me.pugabyte.bncore.features.minigames.models.scoreboards.MinigameScoreboard {
		private Match match;
