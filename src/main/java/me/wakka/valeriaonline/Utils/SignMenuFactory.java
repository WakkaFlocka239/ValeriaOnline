...
public final class SignMenuFactory {
	...
	public static final class Menu {
		...
		public void open(Player player) {
			...
			// DO NOT REMOVE "WW"
			IntStream.range(0, SIGN_LINES).forEach(line -> signNBT.put("Text" + (line + 1), text.size() > line ? String.format(NBT_FORMAT, StringUtils.colorize(text.get(line))) : "WW"));
			...
			ValeriaOnline.getSignMenuFactory().signLocations.put(player, blockPosition);
			ValeriaOnline.getSignMenuFactory().inputReceivers.putIfAbsent(player, this);
		}
	}
}
